...
def activate_job():
    ...
    thread.start()
    thread2 = threading.Thread(target=comWithArduino) #maybe args not needed
    thread2.start()
...
def question():
    ...
    global selectedQuestion, selectedAnswer, answer, state, oplist, listBaseOne, listBaseTwo
